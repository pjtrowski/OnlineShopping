...
import com.hoyrak.validator.ProductInfoValidator;
...
public class AdminController {
    ...
    public String orderList(Model model, //
        ...
        = orderDAO.listOfOrdersInfo(page, MAX_RESULT, MAX_NAVIGATION_PAGE);
    ...
    public String orderView(Model model, @RequestParam("orderId") String orderId) {
        ...
        List<OrderDetailInfo> details = this.orderDAO.listOfOrderDetailsInfo(orderId);
