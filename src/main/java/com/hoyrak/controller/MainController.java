...
import com.hoyrak.util.Utils;
import com.hoyrak.validator.CustomerInfoValidator;
...
public class MainController {
    ...
    public String shoppingCartConfirmationSave(HttpServletRequest request, Model model) {
        ...
        Utils.storeLastOrderInCartSession(request, cartInfo);
    ...
    public String shoppingCartFinalize(HttpServletRequest request, Model model) {
        ...
        CartInfo lastOrderedCart = Utils.getLastOrderedCartInfoSession(request);
